Shader "Roystan/Toon/Water Tut"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma multi_compile_fog        // <<< FOG ACTIVADO
            ...
            struct v2f
            {
                ...
                UNITY_FOG_COORDS(3)      // <<< AGREGADO PARA FOG
            };
            ...
            v2f vert (appdata v)
            {
                ...
                UNITY_TRANSFER_FOG(o, o.vertex);   // <<< TRANSFERENCIA DE FOG
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                UNITY_APPLY_FOG(i.fogCoord, finalColor);   // <<< APLICACIÓN DE FOG
